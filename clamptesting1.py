...
shapesyn1 = Synapses(midneur16, whichshape16, clock=sensors.clock,
                   model= syn_eqns, 
                   on_pre=''' z_exc+= w 
                              apre += Apre
                              w = clip(w+apost, -0.2, 0.2)''',
...
shapesyn2 = Synapses(midneur16, whichshape16, clock=sensors.clock,
                   model= syn_eqns, 
                   on_pre=''' z_exc+= w 
                              apre += Apre
                              w = clip(w+apost, -0.2, 0.2)''',
...
shapesyn3 = Synapses(midneur16, whichshape16, clock=sensors.clock,
                   model= syn_eqns, 
                   on_pre=''' z_exc+= w 
                              apre += Apre
                              w = clip(w+apost, -0.2, 0.2)''',
